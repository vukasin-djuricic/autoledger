        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // NOTE: "xmin" is PostgreSQL's built-in system column used as the optimistic
                    // concurrency token (mapped in JournalEntryConfiguration). It already exists on
                    // every table, so it must NOT be created here.
                },
                constraints: table =>
                {
